rooms = [{:building_name => 'HRBB', :room_id => 126, :roomtype => 'Executive Room',
        ...
        :description=> 'Lecture hall', :booked=>true, :booker=> 'Admin', 
        ...
        :description=> 'Lecture hall', :booked=>true, :booker=> 'amy', 
        :operate_start=> Time.parse("04-01-19 08:00"),
        :operate_end =>  Time.parse("04-01-19 19:00")},
        {:building_name => 'HRBB', :room_id => 113, :roomtype => 'Lecture Hall',
        :description=> 'Lecture hall', :booked=>true, :booker=> 'anthony', 
        :operate_start=> Time.parse("04-01-19 08:00"),
        :operate_end =>  Time.parse("04-01-19 19:00")},
        {:building_name => 'HRBB', :room_id => 104, :roomtype => 'Lecture Hall',
        :description=> 'Lecture hall', :booked=>true, :booker=> 'jordan', 
        :operate_start=> Time.parse("04-01-19 08:00"),
        :operate_end =>  Time.parse("04-01-19 19:00")},
        {:building_name => 'RDMC', :room_id => 111, :roomtype => 'Computer Lab',
        :description=> 'Computer Lab', :booked=>false, 
        :operate_start=> Time.parse("04-01-19 08:00"),
        :operate_end =>  Time.parse("04-01-19 19:00")},
        ...
        :operate_start=> Time.parse("04-01-19 08:00"),
        :operate_end =>  Time.parse("04-01-19 19:00")},
        {:building_name => 'RDMC', :room_id => 211, :roomtype => 'Lecture Hall',
        :description=> 'Lecture Hall', :booked=>false, 
        :operate_start=> Time.parse("04-01-19 08:00"),
        :operate_end =>  Time.parse("04-01-19 19:00")},
        {:building_name => 'RDMC', :room_id => 212, :roomtype => 'Lecture Hall',
        :description=> 'Lecture Hall', :booked=>false, 
        :operate_start=> Time.parse("04-01-19 08:00"),
        :operate_end =>  Time.parse("04-01-19 19:00")},
